...
$(function() {
            $('#session_table').DataTable({
                ...
                columns: [
                    ...
                    { data: 'coaches[].name', name: 'coaches[].name' },
...
/* Show */ {
    mRender: function (data, type, row) {
                        return '<center><a href="/sessions/'+row.id+'" class="table-delete btn btn-info" data-id="' + row.id + '">Show</a></center>'
                    }
                },
                /* EDIT */ {
                    mRender: function (data, type, row) {
                        return '<center><a href="/sessions/'+row.id+'/edit" class="table-edit btn btn-warning" data-id="' + row.id + '">Edit</a></center>'
                    }
                },
                /* DELETE */ {
                    mRender: function (data, type, row) {
